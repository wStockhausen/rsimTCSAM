#'
#'@title Write simulation results to TCSAM2013 input file.
#'
#'@description Function to write simulation results to TCSAM2013 input file.
#'
...
#'@export
#'
writeSim.TCSAM2013<-function(mc,mp,mr,out.dir='.',showPlot=TRUE){
    d<-mc$dims;
    ...
    cat("#####################################################################\n",file=conn);
    cat("#TCSAM2013 Model Configuration File                                 #\n",file=conn);
    cat("#####################################################################\n",file=conn);
    ...
    cat("#####################################################################\n",file=conn);
    cat("#TCSAM2013 Model Datasets File                                      #\n",file=conn);
    cat("#####################################################################\n",file=conn);
    ...
    cat("\n\n",file=conn)
    cat("#####################################################################\n",file=conn);
    cat("#TCSAM2013 Model Biological Info File                               #\n",file=conn);
    cat("#####################################################################\n",file=conn);
    ...
    #Fisheries Data
    fshs<-writeSim.TCSAM2013.Fisheries(mc,mp,mr,fnFshs,out.dir=out.dir,showPlot=showPlot);
    
    #Surveys Data
    srvs<-writeSim.TCSAM2013.Surveys(mc,mp,mr,fnSrvs,out.dir=out.dir,showPlot=showPlot);
