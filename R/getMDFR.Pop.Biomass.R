#'
#'@title Get population biomass time series from model results from rsimTCSAM model runs as a dataframe
#'
#'@description Function to get population biomass time series from model results from rsimTCSAM model runs as a dataframe.
#'
...
#'@export
#'
getMDFR.Pop.Biomass<-function(rsims,cast="y+x",verbose=FALSE){
    if (verbose) cat("--rsimTCSAM::Getting population biomass time series.\n");
