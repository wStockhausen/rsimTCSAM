#'
#'@title Write model survey results to TCSAM02 input file.
#'
#'@description Function to write model survey results to TCSAM02 input file.
#'
...
#'@export
#'
writeSim.TCSAM02.Surveys<-function(mc,mp,mr,fnSrvs,out.dir='.',showPlot=TRUE){
    #model dimensions
    d <- mc$dims;
